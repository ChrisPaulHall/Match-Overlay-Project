...
INPUT_CSV = "opensecrets2.csv"
OUTPUT_CSV = "opensecrets_scraped_summary.csv"
...
def main():
    ...
    with open(INPUT_CSV, newline='', encoding='utf-8') as infile, \
        ...
        fieldnames = ['first_name', 'last_name', 'slug_url', 'top_contributors', 'top_industries']
        ...
        for row in reader:
            ...
            time.sleep(1.5)  # Be respectful to OpenSecrets.org
